<template>
    <ion-page>
        <ion-content :fullscreen="true">
            ...
            <section class="sec-activity-post__content">
                ...
                <div class="sec-activity-post__content__heading d-flex align-center justify-between">
                    ...
                    <div class="sec-activity-post__content__heading__duration d-flex align-center">
                        ...
                        <div class="sec-activity-post__content__heading__duration__text h5 bold ml-10">1 Day</div>
                    </div>
                </div>
                <!-- Address -->
                ...
                <div class="sec-activity-post__content__infos mt-50 d-flex flex-wrap justify-between">
                    <!-- call company -->
                    <div class="cp-tag-category mr-10">
                        ...
                        <div class="cp-tag-category__text mt-10 small ml-20 mr-20">
                            Call Company
                        </div>
                    </div>
                    <!-- budget -->
                    <div class="cp-tag-category border-round mr-10">
                        <div class="cp-tag-category__icon m-0 width-content">
                            $$
                        </div>
                        <div class="cp-tag-category__text mt-10 small ml-20 mr-20">
            ...
            <!-- *** SEC - Reviews *** -->
            <section class="sec-activity-post__reviews">
                <!-- Rating -->
                <div class="sec-activity-post__reviews__rating">
                ...
                <div class="d-flex justify-between flex-no-wrap">
                    ...
                    <!-- Published at -->
                    <div class="sec-activity-post__reviews__published small mt-20">
                        Wen 3 April 2022
                    </div>
                </div>
                <!-- Description -->
                <div class="sec-activity-post__reviews__description mt-20">
